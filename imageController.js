...
const imageController = async (req, res) => {
    try {
        ...
        const outputVideoPath = './data/outputVideo2.mp4';


        // Additional code for video editing can be added here...
        const ffmpegCommand = `"${ffmpegPath}" -i "${inputVideoPath}" -i "${convertedImagePath}" -filter_complex "overlay=10:10" "${outputVideoPath}"`;
